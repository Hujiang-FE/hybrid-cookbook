...
* 安卓碎片化现象仍然十分严重，不幸中的万幸的是：随着安卓4.4版本(KitKat)的普及，Web前端开发终于可以开始大胆地在项目中引入一些务实可靠的新特性，比如布局类的flex，比如标签类datalist等，因为在KitKat版本之后，系统webkit的webview实现已经被替换为基于Chromium的webview实现。
...
* Web架构为重
  * PhoneGap之流，直接跨平台，全web开发，但是用户体验风险极大，比如，需要还原一个类似原生的设置界面，需要大量的html,css代码，做出来的效果还不一定能达到效果。
  * 兼容工作还是要做，而且很痛苦
...
所以，知识篇就让我们从最熟悉的容器-**WebView**开始说起吧。